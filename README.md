...
Welcome to the Deep Reinforcement Learning (DRL) for Stock Trading project! This repository contains an implementation of more than 900 lines of code of a custom Proximal Policy Optimization (PPO) algorithm applied to stock trading using the Gymnasium environment and stable_baselines3 library. The goal of this project is to empower an intelligent agent to learn optimal investment strategies and increase net worth by dynamically managing the allocation of assets.
